...
class BP_Core_Whos_Online_Disappearing_Widget extends WP_Widget {
	...
	public function __construct() {
		...
		$description = __( 'Profile photos of online users if user is logged in', 'buddypress' );
		parent::__construct( false, $name, array(
			'description'                 => $description,
			'classname'                   => 'widget_bp_core_whos_online_disappearing_widget buddypress widget',
	...
	public function widget( $args, $instance ) {
		...
		/**
		 * Filters the title of the Who's Online Disappearing widget.
		 *
		 * @since 1.8.0
	...
	/**
	 * Update the Who's Online Disappearing Widget options.
	 *
	 * @since 1.0.3
	 *
